...
function Input({
  ...
  rules,
  className,
  classNameInput = 'text-sm p-3 w-full outline-none border border-gray-300 focus:border-gray-500 rounded-sm focus:shadow-sm',
    ...
    <div className={'relative ' + className}>
      ...
      {rest.type === 'password' && visibleEye && (
        <svg
          ...
          strokeWidth='1.5'
          stroke='currentColor'
          className='w-4 h-4 absolute right-0 top-0 translate-y-2/3 translate-x-[-50%]'
          onClick={toogleEye}
        >
          <path
            strokeLinecap='round'
