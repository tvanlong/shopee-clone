...
function Pagination({ queryConfig, pageSize }: Props) {
  ...
  const renderPagination = () => {
    ...
    return Array(pageSize)
      ...
      .map((_, index) => {
        ...
        // console.log('Lần thứ: ', index + 1)
        // console.log('page', page)
        // console.log('pageNumber', pageNumber)
        // console.log(pageNumber < pageSize - RANGE + 1)
  ...
  return (
    <div className='flex flex-wrap mt-6 justify-center'>
      {page === 1 ? (
        <button className='bg-white rounded cur cursor-not-allowed px-3 py-2 shadow-sm mx-2 border bg-white/60'>
          Trang trước
        </button>
      ) : (
        <Link
